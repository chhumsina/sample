...
<div class="row form">
	...
	<div class="col-md-9">
		...
		{{ Form::open(array('url' => url('lucky/print-ticket'), 'files'=>true,'class'=>'form-horizontal', 'id'=>'form', 'style'=>'border:solid gray 0px')) }}
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				{{ Form::select('adv', array('' => 'Please Select')+$advanceDraws, null, array('class' => 'form-control','id' => 'advanceDraw','required'=>'required'))}}
			</div>
		</div>
			...
			@foreach ($item->num as $num)
				@if($count%2===0)
					<div class="item">
						...
						<div class="qrcode">
							<div id="qrcode{{$count}}"></div>
							<script type="text/javascript">
								new QRCode(document.getElementById("qrcode{{$count}}"), "<?php echo $num->tsn;?>");
							</script>
