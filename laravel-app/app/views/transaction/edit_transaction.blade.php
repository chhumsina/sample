...
if (Input::old('atr1_value')) {
	...
	$bankId = $transaction->atr1_value;
}
if (Input::old('atr2_value')) {
	$bankAccName = Input::old('atr2_value');
} else {
	$bankAccName = $transaction->atr3_value;
}
?>
...
<div class="row">
	<div class="col-md-12">
		{{ Form::open(array('url' => 'transactions/update')) }}
			<div class="row">
		    ...
		    <?php if ($transaction->service_type__id == 'deposit' || $transaction->service_type__id == 'deposit_game') {
					 	if (Entrust::can('edit_deposit')) {
			    	  		if ($transaction->status == 'TS') {
			    	  			...
			    	  			<div class="row">
								  	...
								  	<div class="col-md-4 text-left">
								  		{{ Form::select('atr1_value', array('' => 'Please Select')+$banks, $transaction->atr1_value, array('id'=>'banks','class' => 'form-control','required'=>'required')) }}
								  	</div>
								</div>
								<div class="row">
								  	<div class="col-md-4 text-right">
								  	...
								  	<div class="col-md-4 text-left">
								  		{{ Form::select('atr2_value', array('' => 'Please Select'), $transaction->atr1_value, array('id'=>'bank_acc_names','class' => 'form-control')) }}
								  		{{ Form::hidden('bank_acc_name_hidden', $transaction->atr2_value, array('id'=>'bank_acc_name_hidden')) }}
								  	</div>
								</div>
								<div class="row">
								  	<div class="col-md-4 text-right">
								  	...
								  	<div class="col-md-4 text-left">
								  		{{ Form::text('atr3_value', $transaction->atr3_value, array('id'=>'account_number','class' => 'form-control','placeholder'=>'Account Number','disabled'=>'disabled')) }}
					    	  	...
					    	  	<div class="row">
								  	...
								  	<div class="col-md-4 text-left">
								  		{{ Form::textarea('remark', $transaction->remark, array('class' => 'form-control','placeholder'=>'Remark','size' => '30x5','required'=>'required')) }}
								  	</div>
								</div>
					    		<div class="row">
									<div class="col-md-4 text-right">
								  	...
								  	<div class="col-md-4 text-left">
								  		{{ Form::submit('Confirm Update',array('class' => 'btn btn-primary','name'=>'approve','value'=>'update')) }}
								  	</div>
								</div>
