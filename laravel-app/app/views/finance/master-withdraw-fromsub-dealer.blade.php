@section('title', 'Master Withdraw From Sub Dealer')
@section('content')
<?php
$baseUrl = URL::to('/');
$dealerId = '';
...
<h4>Master Withdraw From Sub Dealer</h4>
@include('layouts.partial.render-message')
<div class="row">
	<div class="col-md-12">
		{{ Form::open(array('url' => 'finances/master-withdraw-fromsub-dealer')) }}
			<div class="row">
			  	<div class="col-md-4 text-right">
			  		{{ Form::label('master_dealer__id', 'Master Dealer ID*:') }}
			  	</div>
			  	<div class="col-md-4 text-left">
		         	{{ Form::text('master_dealer__id', '', array('class' => 'form-control','id' => 'master_withdraw' , 'list' =>'dealer_list' , 'placeholder'=>'Master Dealer ID','required'=>'required')) }}
			...
			<div class="row">
			  	<div class="col-md-4 text-right">
			  		{{ Form::label('requested_value', 'Withdraw Amount*:') }}
			  	</div>
			  	<div class="col-md-4 text-left">
			  		{{ Form::text('requested_value', '', array('class' => 'form-control','placeholder'=>'Withdraw Amount','required'=>'required')) }}
			  	</div>
			</div>
			<div class="row">
			  	<div class="col-md-4 text-right">
