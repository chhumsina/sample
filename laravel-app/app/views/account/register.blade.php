...
@section('content')
	...
	<div class="col-sm-7 padding-right">
		...
		<?php echo Form::open(array('url' => 'register','role' => 'form', 'class'=>'form-inline')) ?>
					<table class="table table-user-information">
						...
						<tr>
							<td>{{ Form::label('cpassword', 'Confirm Password:') }}</td>
							<td>{{ Form::password('cpassword', array('class' => 'form-control','id'=>'cpassword')) }}</td>
						</tr>
						</tbody>
					</table>
